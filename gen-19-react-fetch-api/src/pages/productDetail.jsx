...
export default function ProductDetail() {
    ...
    // useEffect(() => {
    //     if(product){
    //         setProd(product.dataPrev[0].dataPreview)
    //         setPrev(1)
    //         setColor(product.dataColor[0].name)
    //         setSize(product.dataSize[0])
    //     }
    // }, [product]);
    ...
    return (
        <div className="m-0">
            ...
            <div className="max-w-[80%] m-auto mt-[2vh] mb-[5vh]">
                <Breadcrumb/>
                <div className="text-xl md:text-3xl mb-6 font-bold"></div>
                        ...
                        <div className="flex justify-between">
                            {isLoading ? <HashLoader/> :
                                <ul name="" id="imageList" className="flex flex-col gap-2 z-0 max-h-96 overflow-y-scroll overflow-x-hidden">
                                    {product.dataPrev?.map((preview,i)=>(
                                        <li key={i}>
                        ...
                        <div className="flex flex-col space-y-2">
                            ...
                            { isLoading ? <HashLoader/> : 
                                <div id="sizeList" className="flex space-x-2">
                                    {product.dataSize?.map((datasize,i)=>(
